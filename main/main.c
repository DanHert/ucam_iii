...
void app_main(void) {
 ...
 /*  /1* sendCommand(INIT_ID, 0x00, INIT_P2_JPEG, 0x07, INIT_P4_JPEG_160X128, 100); *1/ */
 ...
 /*  } */
  ...
  /* int     len = uart_read(datakeeper, 40000, 1000 / portTICK_RATE_MS); */
